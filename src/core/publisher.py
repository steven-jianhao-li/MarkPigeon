...
class GitHubPublisher:
    ...
    def get_or_create_repo(self) -> Repository:
        ...
        try:
            repo = self._user.create_repo(
                name=self.repo_name,
                description="📄 My MarkPigeon document shelf - HTML pages generated by [MarkPigeon](https://github.com/steven-jianhao-li/MarkPigeon)",
    ...
    def star_repo(self, repo_full_name: str = MARKPIGEON_REPO) -> tuple[bool, str]:
        ...
        try:
            ...
            return True, f"⭐ Thank you for starring {repo_full_name}!"
        except GithubException as e:
            if "already starred" in str(e).lower() or e.status == 304:
                return True, "You've already starred this repo. Thank you! 💖"
